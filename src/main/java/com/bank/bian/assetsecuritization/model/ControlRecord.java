package com.bank.bian.assetsecuritization.model;
...
/**
 * The BIAN control record for this service domain: "Securitization Pool Procedure".
 *
 ...
 * to its asset type (Securitization Pool). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Securitization Pool Procedure";
